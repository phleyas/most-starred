...
export class GithubApiService {
   ...
   */
  getMostStarredRepositories(startDate: string, page = 1): Observable<GithubApiResponse> {
   ...
   * @param page number starting from 1
   */
  getMostStarredRepositoriesAsync(startDate: string, page = 1): Promise<GithubApiResponse> {
